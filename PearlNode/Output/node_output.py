...
class NodeResult(NodeBase):
    """A simple Result node"""
    bl_idname = "NodeResult"
    bl_label = 'Node Result'
    ...
    def init(self, context):
        self.create_input('PearlNodeSocketResult', 'input', 'Input')
        self.width = 200
...
def register():
    bpy.utils.register_class(NodeResult)
...
def unregister():
    bpy.utils.unregister_class(NodeResult)
